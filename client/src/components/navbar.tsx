...
const Navbar = () => {
  ...
  {
    /* Handler function for Search form*/
  }
  ...
  return (
    <nav className="bg-white sticky top-0 z-50 border-b border-app-border">
      ...
      >
        ...
        <Link
          to="/"
          className="flex items-center gap-2 text-[22px] font font-medium shrink-0"
        >
          ...
          >
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-8 p-2 bg-orange-50 rounded-full ring ring-app-orange/60
            ...
            <div className="relative">
              {user ? (
                ...
                <div className="flex-center gap-2">
                  <Link
                    to="/login"
                    className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white
                   bg-green-950 rounded-full hover:bg-green-950-light transition-colors"
                  >
              ...
              {userMenuOpen && (
                <>
                  ...
                  />
                  <div
                    className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border
